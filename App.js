...
import { Container, Header, Content, Footer, Item, Input,Icon,
        Button,Text, Card, CardItem, Thumbnail, Left, Right, Body,Fab } from 'native-base';
    ...
    render() {
        const data = this.state.restaurants.map(resto => {
            return <Card style={{ flex: 0 }}>
                ...
                <CardItem>
                    <Left>
                        <Button transparent textStyle={{ color: '#ff5050' }}>
                            <Icon name="home" />
        ...
        return (
            <Container>
                ...
                <Text
                    style={{ textAlign: 'center', padding: 10, fontSize: 24, fontWeight: '800' }}
                >
